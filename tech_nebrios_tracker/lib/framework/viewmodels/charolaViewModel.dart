...
class CharolaViewModel extends ChangeNotifier {
  ...
  // === LISTADO DE CHAROLAS CON PAGINACIÓN ===
  List<CharolaTarjeta> charolas = []; // Lista de tarjetas de charolas
  int pagActual = 1; // Página actual
  final int limite = 15; // Elementos por página
  bool _cargandoLista = false; // Bandera de carga del listado
  bool get cargandoLista => _cargandoLista;
  bool hayMas = true; // Indica si hay más páginas disponibles
  int totalPags = 1; // Total de páginas disponibles
