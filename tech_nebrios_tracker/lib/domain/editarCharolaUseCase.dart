...
abstract class EditarCharolaUseCase {
  Future <Map<dynamic,dynamic>> editarCharola(charolaId, nombreCharola, nuevoEstado, nuevaDensidad, nuevaAlimentacion, nuevaAlimentacionOtorgada, fechaActualizacion, nuevaHidratacion, nuevaHidratacionOtorgada, fechaCreacion);
}
...
class EditarCharolaUseCaseImp extends EditarCharolaUseCase{
  ...
  @override
  Future <Map<dynamic,dynamic>> editarCharola(charolaId, nombreCharola, nuevoEstado, nuevaDensidad, nuevaAlimentacion, nuevaAlimentacionOtorgada, fechaActualizacion, nuevaHidratacion, nuevaHidratacionOtorgada, fechaCreacion){
    return repositorio.putEditarCharola(charolaId, nombreCharola, nuevoEstado, nuevaDensidad, nuevaAlimentacion, nuevaAlimentacionOtorgada, fechaActualizacion, nuevaHidratacion, nuevaHidratacionOtorgada, fechaCreacion);
  }
}